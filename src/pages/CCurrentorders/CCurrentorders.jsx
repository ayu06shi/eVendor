...
const CCurrentorders = (props) => {
  ...
  const apicustomer = async () => {
    ...
    const options = {
      method: "GET",
      url: "http://localhost:8009/api/web3/customer",
  ...
  const apicustomerdone = async () => {
    ...
    const options = {
      method: "GET",
      url: "http://localhost:8009/api/web3/customerdone",
      params: { CUser: customer },
    };
    axios
      .request(options)
  ...
  const customerDeny = async (e, id, hash) => {
    ...
    if (res.events.success.returnValues[1]) {
      ...
      console.log(data);
      await axios.post(
        "http://localhost:8009/api/web3/customerdeny",
        data
      );
  ...
  const partialPayment = async () => {
    ...
    try {
      ...
      if (res.events.success.returnValues[1]) {
        ...
        ////////////////////////////////////////////////////
        await axios.post(
          "http://localhost:8009/api/web3/customeraccept",
          data
        );
        window.location.reload();
      }
  ...
  return (
    <div style={{ color: "white", paddingBottom: "15vh" }}>
      <Modal
        className="mode"
        open={open}
                    ...
                    <Tr key={index}>
                      ...
                      <Td>
                        {note.HawkerStage === "Waiting" ? (
                          ...
                          <Button
                            variant="success"
                            onClick={(event) =>
                              customerAccept(event, note._id, note.Hash)
                            }
                          >
                            Pay
                          </Button>
                      ...
                      <Td>
                        <Button
                          variant="danger"
                          onClick={(event) =>
                            customerDeny(event, note._id, note.Hash)
                          }
                        >
                          Cancel
                        </Button>{" "}
