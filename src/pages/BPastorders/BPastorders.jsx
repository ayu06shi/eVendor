...
const BPastorders = (props) => {
  ...
  const apihawkerdone = async () => {
    const options = {
      method: "GET",
      url: "http://localhost:8009/api/web3/hawkerdone",
      params: { HUser: hawker },
    };
    axios
      .request(options)
  ...
  const hawkerAccept = async (e,id,hash) => {
    ...
    {  
      ...
      console.log(data);
      await axios.post("http://localhost:8009/api/web3/hawkeraccept", data);
  ...
  const hawkerReach = async (e,id,lat,long,hash) => {
    ...
    {   
        await axios.post("http://localhost:8009/api/web3/hawkerreach", data);
        window.location.reload();
    }
  }
  const hawkerReceive = async (e,id,hash) => {
    ...
    if(res.events.success.returnValues[1])
    {
      //console.log(id);
        ...
        console.log(data);
        await axios.post("http://localhost:8009/api/web3/hawkerreceive", data);
        window.location.reload();
    }
  }
  ...
  const hawkerDeny = async (e,id,hash) => {
    ...
    if(res.events.success.returnValues[1])
    {
      ...
      console.log(data);
      await axios.post("http://localhost:8009/api/web3/hawkerdeny", data);
      window.location.reload();
    }
  }
